...
✅ ADDED: Portugal microclimate adjustments (wind boost, valley inversion, fog, MTB hazards)
✅ FIXED: Weathercode prioritizes physical conditions over API codes
✅ FIXED: Real irradiance from Open-Meteo (not generic 400 W/m²)
✅ FIXED: Microclimate applied ONCE per data flow
✅ KEEP: EEI_v31 100% intacto
✅ KEEP: Surgical fixes nieve (#1-4)
✅ KEEP: All original outputs (PNG cards, JSON, banner, map)
...
# ═══════════════════════════════════════════════════════════════════════════
# WEATHERCODE MEJORADO - PRIORIZA FÍSICA
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# MICROCLIMA PORTUGAL - AJUSTES LOCALES
# ═══════════════════════════════════════════════════════════════════════════
...
def generate_ui_card(sector, data_now, data_3h, data_6h, time_str):
    ...
    if is_snow or is_mixed:
        ...
        plt.text(0.08, 0.40, weather_label, color='white', alpha=0.10, fontsize=40, fontweight='bold', transform=ax.transAxes)
...
status_data = {
    ...
    "event": "MQ2026",
    "model_version": "v3.1 + Portugal Microclimate (V18.3 Enhanced)",
    ...
    "enhancements": [
        ...
        "Real irradiance from Open-Meteo"
    ],
    "surgical_fixes": [
...
print("   ✅ Real irradiance from Open-Meteo API")
print("   ✅ Single-pass microclimate application")
print("\n✨ SURGICAL FIXES (V18.2):")
