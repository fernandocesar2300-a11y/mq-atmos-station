# -*- coding: utf-8 -*-
# === MQ ATMOS LAB: BELLATOR V16.7 (GPS TRACKER) ===
# OBJETIVO: Descubrir dónde está aterrizando el FTP realmente.
# AÑADIDO: Comandos de diagnóstico 'pwd' y 'nlst' antes de subir.
...
print("📡 INICIANDO SISTEMA V16.7 (GPS MODE)...")
...
if "FTP_USER" in os.environ:
    ...
    try:
        ...
        # 1. ¿DÓNDE ESTAMOS?
        print(f"📍 RUTA ACTUAL AL CONECTAR: {session.pwd()}")
        
        # 2. ¿QUÉ HAY AQUÍ?
        print(f"📂 CONTENIDO CARPETA ACTUAL: {session.nlst()}")
        
        # 3. INTENTO DE SUBIDA
        print("🚀 SUBIENDO ARCHIVOS AQUÍ MISMO...")
        ...
        session.quit()
        print("✅ PROCESO TERMINADO. REVISA LOS LOGS ARRIBA.")
